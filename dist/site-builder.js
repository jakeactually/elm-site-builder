...
var author$project$Update$canBeTarget = F2(
	function (isTop, maybeRow) {
		if (maybeRow.$ === 'Just') {
			var row = maybeRow.a.a;
			return !(isTop && row.isBlock);
		} else {
			return false;
		}
	});
				...
				switch (columnMsg.$) {
					...
					case 'ColumnGapMouseOver':
						...
						return _Utils_update(
							column,
							{
								isTarget: A2(author$project$Update$canBeTarget, isTop, model.currentRow)
							});
