...
var author$project$Json$rowDecoder = F2(
	function (schema, name) {
		var _n0 = A2(elm$core$Dict$get, name, schema);
		if (_n0.$ === 'Just') {
			var fieldsSchemas = _n0.a;
			return A2(
				elm$json$Json$Decode$map,
				function (dict) {
					return A2(
...
var author$project$Util$insert = F3(
	function (index, item, list) {
		var _n0 = A2(author$project$Util$splitAt, index, list);
		var start = _n0.a;
		var end = _n0.b;
		return _Utils_ap(
			start,
...
var author$project$Util$update = F3(
	function (_function, index, list) {
		var _n0 = A2(author$project$Util$get, index, list);
		if (_n0.$ === 'Just') {
			var item = _n0.a;
			return _Utils_ap(
				A2(elm$core$List$take, index, list),
				...
				switch (columnMsg.$) {
					...
					case 'ColumnGapMouseUp':
						return _Utils_update(
							...
							{
								isTarget: false,
								rows: author$project$Util$maybeToList(model.currentRow)
							});
					case 'RowMsg':
						var i = columnMsg.a;
						var rowMsg = columnMsg.b;
...
var author$project$Field$View$renderField = F3(
	function (thumbnailsUrl, index, _n0) {
		var name = _n0.a;
		var value = _n0.b;
		return A2(
			elm$html$Html$map,
...
var author$project$Builder$RowMouseDown = F2(
	function (a, b) {
		return {$: 'RowMouseDown', a: a, b: b};
	});
...
var author$project$Builder$ColumnGapMouseOver = {$: 'ColumnGapMouseOver'};
...
var author$project$Events$onMouseOver = A2(
	...
	A2(
		...
		A2(author$project$Events$options, true, false)),
	elm$json$Json$Decode$succeed);
var author$project$View$columnGap = function (isTarget) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						author$project$Events$onMouseOver(author$project$Builder$ColumnGapMouseOver),
...
var author$project$Builder$GapMouseOver = {$: 'GapMouseOver'};
var author$project$Builder$GapMouseUp = {$: 'GapMouseUp'};
var author$project$View$rowGap = F2(
	function (model, isTarget) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('sb-dropzone'),
							author$project$Events$onMouseOver(author$project$Builder$GapMouseOver),
	...
	function (model, basis, i, column) {
		...
		return A2(
			...
			A2(
				...
				(elm$core$List$length(rows) > 0) ? A2(
					elm$core$List$cons,
					...
					[
						author$project$View$columnControl(column),
						author$project$View$columnGap(isTarget)
					])));
	});
					...
					[
						...
						_List_fromArray(
							[
								...
								author$project$Builder$RowMouseDown(row)),
						...
						A2(author$project$View$rowGap, model, isTarget)
					])));
	});
...
var author$project$SiteBuilder$main = elm$browser$Browser$element(
	{
		...
		subscriptions: function (_n0) {
			var currentForm = _n0.currentForm;
			var currentFieldIndex = _n0.currentFieldIndex;
			var _n1 = currentForm;
			var fields = _n1.b;
